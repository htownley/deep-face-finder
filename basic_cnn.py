...
train_step = tf.train.AdamOptimizer(learning_rate=.0001, beta1=0.9, beta2=0.999).minimize(cross_entropy)
'''
learning_rate=.001 >>>>>> 0.9929
learning_rate=.0001 >>>>>> 0.9932
learning_rate=.0005 >>>>>> 0.9927
learning_rate=.0002 >>>>>> 0.9917
learning_rate=.00009 >>>>>> 0.9925

keep_prob: 1.0 >>>>>> 0.9823
'''
