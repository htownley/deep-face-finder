...
print("loading data")
test_images, test_labels = fruit_loader('test', 15, number_of_fruits)
train_images, train_labels = fruit_loader('train', 15, number_of_fruits-1, True)
...
with tf.Session() as sess:
  ...
  for epoch in range(num_epochs):
      ...
      print accuracy.eval(feed_dict={x: test_images, labels: test_labels, keep_prob: 1.0})
